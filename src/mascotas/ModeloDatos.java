...
public class ModeloDatos {
    ...
    public void consultarMascota() {
        int codigo = Integer.parseInt(JOptionPane.showInputDialog("Ingrese codigo de la mascota a buscar"));
        Mascota mascota = mapMascotas.get(codigo);
        if (mascota != null) {
            System.out.println("El codigo de la mascota " + codigo + ":");
            mascota.mostrarInformacion();
        } else {
            System.out.println("No se encontr� una mascota con el c�digo."+ codigo);
        }
    }
